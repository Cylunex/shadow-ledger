...
class Settings(BaseSettings):
    ...
    mcp_agent_v2: bool = False
    mcp_skill: Literal["research", "capture", "steward"] = "research"
    mcp_disclosure: Literal["remote_minimal", "local_private"] = "remote_minimal"
    ...
    def secure_production(self) -> Settings:
        ...
        if self.mcp_http_enabled and (not self.agent_registry_path or not self.allowed_origins):
            raise ValueError("remote MCP requires Agent registry and explicit origins")
